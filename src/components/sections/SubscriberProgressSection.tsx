...
const SubscriberProgressSection: React.FC = () => {
  ...
  const getMilestoneInfo = (goal: number) => {
    if (goal <= 10)
      return {
        icon: Target,
        message: "Premier objectif !",
        color: "text-cyan-400",
      };
    if (goal <= 50)
      return {
        icon: Star,
        message: "Montée fulgurante !",
        color: "text-purple-400",
      };
    if (goal <= 100)
      return {
        icon: Trophy,
        message: "Centaine atteinte !",
        color: "text-yellow-400",
      };
    if (goal <= 1000)
      return {
        icon: Crown,
        message: "Direction le K !",
        color: "text-pink-400",
      };
    if (goal <= 10000)
      return {
        icon: Sparkles,
        message: "10K magiques !",
        color: "text-cyan-400",
      };
    if (goal <= 100000)
      return {
        icon: Gift,
        message: "Communauté massive !",
        color: "text-purple-400",
      };
    if (goal <= 1000000)
      return {
        icon: Crown,
        message: "Vers les 100K+ !",
        color: "text-yellow-400",
      };
    return {
      icon: Trophy,
      message: "Million en vue !",
      color: "text-pink-400",
    };
  };
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          <div className="relative">
            {/* Glow effect */}
            <div
              className={`absolute -inset-4 bg-gradient-to-r rounded-3xl blur-2xl opacity-20 ${
                showCelebration
            ...
            <div className="relative bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 lg:p-12">
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="relative">
                    <div
                      className={`text-6xl lg:text-7xl font-bold transition-all duration-500 ${
                        showCelebration
                ...
                <div className="text-center lg:text-right">
                  <div className="flex items-center gap-2 text-slate-400 text-sm uppercase tracking-wider mb-4 justify-center lg:justify-end">
                    <MilestoneIcon
                      className={`w-4 h-4 ${milestoneInfo.color}`}
                    />
                  ...
                  <div
                    className={`text-lg font-semibold ${milestoneInfo.color}`}
                  >
